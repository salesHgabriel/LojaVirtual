...
<div class="login-box">
	<div class="login-logo">
		<a href="#"><b>Loja virtual</b>GS</a>
	</div>
	<!-- /.login-logo -->
	<div class="login-box-body">
		<p class="login-box-msg"><b>Login de acesso</b></p>

		<form action="" method="post">
			<div class="form-group has-feedback">

				<input type="email" class="form-control" id="validationCustom03" placeholder="E-mail" name="email">
